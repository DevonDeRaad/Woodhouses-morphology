...
#most of the differences between the sexes are explained by the males having larger general body size (PC1)
...
#now we can use the values of PC1 as a proxy for general body size in downstream analyses
...
#Make manuscript Figure 4 A&B#
##plot s1b for 3 groups
ggplot(PCAscrubspecmorph, aes(x = S1.blue, y = locality, fill = locality, point_color = locality)) +
  ...
  labs(x = "Blue Saturation of Back Plumage", y = "Group") +
